...
namespace TTU_CORE_ASP_ADMISSION_PORTAL.Data.Migrations
{
    ...
    [Migration("20210319010138_ApplicantModel1")]
    partial class ApplicantModel1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TTU_CORE_ASP_ADMISSION_PORTAL.Models.ProgrammeModel", b =>
                {
                    ...
                    b.Property<int?>("ApplicantModelID1")
                        .HasColumnType("integer");

                    b.Property<int?>("ApplicantModelID2")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ApplicantModelID1");

                    b.HasIndex("ApplicantModelID2");
            ...
            modelBuilder.Entity("TTU_CORE_ASP_ADMISSION_PORTAL.Models.ProgrammeModel", b =>
                {
                    b.HasOne("TTU_CORE_ASP_ADMISSION_PORTAL.Models.ApplicantModel", null)
                        .WithMany("FirstChoice")
                        .HasForeignKey("ApplicantModelID");

                    b.HasOne("TTU_CORE_ASP_ADMISSION_PORTAL.Models.ApplicantModel", null)
                        .WithMany("SecondChoice")
                        .HasForeignKey("ApplicantModelID1");

                    b.HasOne("TTU_CORE_ASP_ADMISSION_PORTAL.Models.ApplicantModel", null)
                        .WithMany("ThirdChoice")
                        .HasForeignKey("ApplicantModelID2");
                });
