        ...
        if ($uploaded == 0) {
            ...
            if (!is_null($file)) {
                ...
                if (in_array($ext, $valid_exts)) {
                    ...
                    if (filesize($file) <= $max_size) {
                        ...
                        $applicantNumber = "2020" . $applicantNumber;
                        ...
                        if ($file)
                        {
                            ...
                            $curl = curl_init();
                            curl_setopt($curl, CURLOPT_URL, 'https://photos.ttuportal.com/store_file');
            ...
            if (in_array($ext, $valid_exts)) {
                ...
                if (@filesize($file) <= $max_size) {
                    ...
                    /*
                                       if($uploader->upload($uploadDir, $file, $filename)) {
                                           ...
                                           $status = "Error uploading Photo try again later";
                                       }*/
