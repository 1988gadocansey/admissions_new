...
class FormController extends AbstractController
{
    ...
    public function LetterAction()
    {
        ...
        if($data) {
            ...
            $id=$data->getId();
            $url="https://ttuportal.com/arms/1040/letter/print/";

            return $this->redirect("https://ttuportal.com/arms/$id/letter/print/");
        }
        else{
    ...
    public function step1(Request $request, ApplicantService $helper)
    {
        ...
        if ($form->isSubmitted() && $form->get('firstName')->isValid()) {
            if (!$existingApplicant) {
                ...
                $applicant->setYearOfAdmission("2020/2021");
    ...
    {
        $formsType = ["MTECH", "BTECH","ACCELERATED_HND","ACCELERATED_BTECH"];
            $em = $this->getDoctrine()->getManager();
            $user = $this->getUser();
            $formNo = $user->getFormNo();
