    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (!empty($this->existingApplicant)) {
            ...
            $builder
                ...
                ->add('dob', TextType::class, array(  'attr' => array('v-model' => 'dob', 'placeholder'=>'12/02/1990', 'v-form-ctrl' => '', 'required' => '', 'id' => 'dob','class'=>'dob'), 'label'=>'Date of Birth'))
                ...
                ->add('entryQualificationOne', ChoiceType::class, array(  'placeholder' => 'Choose an answer',
                    'choices' => array('WASSSCE' => 'WASSSCE', 'SSSCE' => 'SSSCE', 'TEU/TECHNICAL CERTIFICATES' => 'TEU/TECHNICAL CERTIFICATES', 'NVTI' => 'NVTI', 'Barchelor' => 'Barchelor', 'HND' => 'HND', 'DIPLOMA'=>'DIPLOMA','NECO'=>'NECO','Other' => 'Other','NAPBTEX'=>'NAPBTEX'),
